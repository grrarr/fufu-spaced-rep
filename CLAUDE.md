...
- **Be autonomous** — don't ask for confirmation on commits, pushes, file edits, or routine operations. Just do them. The only checkpoint is showing the drafted question for approval before editing `index.html`.
